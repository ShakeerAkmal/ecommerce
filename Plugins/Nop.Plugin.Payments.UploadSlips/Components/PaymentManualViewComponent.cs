...
namespace Nop.Plugin.Payments.UploadSlips.Components
{
    [ViewComponent(Name = "PaymentUploadSlips")]
    public class PaymentUploadSlipsViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.UploadSlips/Views/PaymentInfo.cshtml", model);
        }
    }
}
